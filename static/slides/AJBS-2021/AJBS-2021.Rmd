...
metathis::include_meta(
  ...
  meta_social(
    ...
    image = "https://kovsiannikov.com/images/Techno-screen.png",
...
.pull-right-wide[## .white.bg-black[industrial coordination] `r fa("handshake", fill = "blue")` large companies & financial institutions]
...
* Only **Chemicals** stand out for its R&D spending that translates into more inventions valued by market. 
...
* institutional features associated with .white.bg-black[R&D spending] provide valuable signals for investors across multiple industries 

--

* quality of a patented output .white.bg-black[(Citations per Patent)] mostly matters for the manufacturing sector

--

* pronounced nonlinear trend in the market perception of .white.bg-black[corporate age]: only the more experienced companies receive market premium as they get older
