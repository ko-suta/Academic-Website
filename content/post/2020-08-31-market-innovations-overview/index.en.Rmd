...
data3 %>%
  kbl(digits = rep(2, 5), align=rep('c', 5), escape = F,
...
data4 %>%
  kbl(digits = rep(2, 5), escape = F,
        align=rep('c', 5), booktabs = T, format = "html",
...
xaringanExtra::embed_xaringan(url = "https://kovsiannikov.com/slides/sase-2019/sase-2019.html", ratio = "4:3")
```
